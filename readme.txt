...
The best Linktree alternative for WordPress!
...
[[Try it for 14 days](https://blastmkt.com/wp-link-bio-wordpress-plugin/?utm_source=wordpress.org&utm_medium=link&utm_campaign=wordpress-plugin-repository&utm_content=trial)] (No credit card required!)
...
2. Search for "WP Link Bio"
3. Click on "Install Now", then click on "Activate"
4. Go to **WP Link Bio > Settings** to configure the plugin
5. Once you finish the setup, add links on **WP Link Bio > Add New Link**

**Expert users way**

1. Go to **Plugins > Add New**
2. Click on "Upload Plugin", then select the zip file
3. Click on "Activate"
4. Go to WP Link Bio > Settings to configure the plugin
5. Once you finish the setup, add links on **WP Link Bio > Add New Link**
...
The easiest way to reorder your links by drag & drop, we strongly recommend you to install the following:
